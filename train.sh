...
PYTHONPATH=. python TIGER/biencoder/train_biencoder.py \
  --data_path data/01_blink_baseline/blink_format/random_sample/2013/ \
  --output_path /models/01_blink_baseline_2013_train_random_test_new/biencoder \
...
PYTHONPATH=. python TIGER/biencoder/eval_biencoder.py \
  --path_to_model /models/01_blink_baseline_2013_train_random_test_new/biencoder/pytorch_model.bin \
  --data_path data/01_blink_baseline/blink_format/new_entities/ \
  --output_path /models/01_blink_baseline_2013_train_random_test_new/ \
